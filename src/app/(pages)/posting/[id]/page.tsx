...
export default function Posting() {
  ...
  //   return (
  //   <div className="w-full h-[80vh] flex justify-center pt-[100px]">  
  //     <div className="w-[400px] h-auto border border-slate-400 background-slate-300 rounded p-4 flex flex-col justify-center items-center">
  //       <h5 className="text-[1.5em] text-slate-600 mb-4 text-bold">This post was not found</h5>
  //       <button
  //         onClick={() => router.back()} 
      ...
      <div className="min-h-[80vh] flex justify-center bg-slate-50">
        <div className="2xl:w-[1200px] xl:w-[1200px] w-auto min-h-[200px] flex 2xl:flex-row xl:flex-row flex-col gap-5 p-5">
          <main className="2xl:p-5 xl:p-5 p-2 h-auto flex-1 border border-slate-300 rounded bg-white">
            ...
            <hr />
            <h5 className="text-[1.5em] text-slate-400 text-bold">...Loading</h5>
          </main>
        </div>
      </div>
    );
